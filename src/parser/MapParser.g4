...
define_feature: DEFINE_FEATURE_START TEXT DEFINE_FEATURE_ICON quoted_text DEFINE_FEATURE_SIZE SIZE STATEMENT_END;
...
function_call: FUNCTION_CALL_START TEXT FUNCTION_PARAM_START NUM (FUNCTION_PARAM_SEP NUM)* FUNCTION_CALL_PARAM_END;
...
area_func: AREA_FROM_FUNC_MAP | (AREA_FRM_FUNC_REGION quoted_text_func); //REVIEW: COMPARE TO REVISED GRAMMAR
...
math_compare: MATH_COMPARE_START MATH_FROM_EXPRESSION_TEXT math_comparison_op MATH_FROM_EXPRESSION_TEXT;
