...
place_region: PLACE_REGION_START REGION FEATURE_OR_REGION_NAME quoted_text FEATURE_OR_REGION_LOCATION xytuple PLACE_REGION_DIMENSIONS xytuple (FEATURE_OR_REGION_DISPLAY boolean_antlr)?;
